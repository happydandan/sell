  ...
  <div class="content">
      ...
      <ul class="supports">
      	<li class="support_item" v-for="(item,index) in seller.supports">
      	  <span class="icon" :class="classMap[index]"></span><span class="text">{{item.description}}</span>
      	</li>
      </ul>
  	</div><!-- bulletin结束 -->
  	<split></split>
  	<div class="pic">
  	  ...
  	  <div class="pic_wrapper" ref="picWrapper">
  	  	<ul class="pic_list" ref="picList">
  	  	  <li class="pic_item" v-for="item in seller.pics">
...
export default {
  ...
  methods: {
    toggleFavorite(event) {
      ...
      saveToLocal(this.seller.id, 'favorite', this.favortie);
    },
  	initScroll() {
  		if (!this.scroll) {
